...
def parse_agrs():
    ...
    parser.add_argument('--image_dir', type=str, default=r'E:\usman\R2Gen\data\iu_xray\images',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default=r'E:\usman\R2Gen\data\iu_xray\annotation.json', help='the path to the directory containing the data.')
    parser.add_argument('--vocab-path', type=str, default=r'E:\usman\R2Gen\data\vocab.pkl')
    ...
    parser.add_argument('--save_dir', type=str, default=r'E:\usman\R2Gen\results\iu_xray', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default=r'E:\usman\R2Gen\records', help='the patch to save the results of experiments.')
    ...
    parser.add_argument('--seed', type=int, default=9233, help='Set seed for reproducibility of results.') #9233
    parser.add_argument('--resume', type=str, help='whether to resume the training from existing checkpoints.')


    parser.add_argument('--num_classes', type=int, default=31)
    parser.add_argument('--current_epoch', type=int, default=0, help='Current epoch number')
